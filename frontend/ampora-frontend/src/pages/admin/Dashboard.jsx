  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* NEW Live Map Section – full width and more detailed */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-3 bg-white rounded-2xl p-6 shadow-lg">
            ...
            {/* Large Map Area */}
            <div className="relative w-full h-96 bg-gradient-to-br from-emerald-50 to-white-100 rounded-xl overflow-hidden">
              ...
              <div className="absolute top-1/2 right-1/3 w-4 h-4 bg-yellow-500 rounded-full animate-pulse shadow-lg"></div>
              <div className="absolute bottom-1/3 left-1/2 w-4 h-4 bg-red-500 rounded-full animate-pulse shadow-lg"></div>
              <div className="absolute top-2/3 left-1/4 w-4 h-4 bg-green-500 rounded-full animate-pulse shadow-lg"></div>
              <div className="absolute top-1/5 right-1/4 w-4 h-4 bg-red-500 rounded-full animate-pulse shadow-lg"></div>
            </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {actions.map((action, index) => (
              <button
                key={index}
                className="group relative overflow-hidden bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl border border-gray-200 hover:border-transparent hover:shadow-xl transition-all transform hover:-translate-y-1"
              >
                <div
                ...
                <div className="relative z-10">
                  <action.icon
                    ...
                    size={32}
                  />
                  <p className="font-semibold text-gray-900 group-hover:text-white transition-colors text-sm">
                    {action.label}
                  </p>
                </div>
              </button>
